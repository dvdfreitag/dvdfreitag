...
// the request data assosciated with the handshake request sent by
// the socket.io client. 'accept' is a callback function use to either
...
io.set('authorization', function(handshakeData, accept) {
	...
	if(handshakeData.headers.cookie) {
		...
		// the cookie value should be signed using the secret configured aboce
 		// use the secret to decrypt the actual session id.
